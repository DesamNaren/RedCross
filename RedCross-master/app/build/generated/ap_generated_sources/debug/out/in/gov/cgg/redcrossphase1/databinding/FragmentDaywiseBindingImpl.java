...
public class FragmentDaywiseBindingImpl extends FragmentDaywiseBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.rv_daywiselist, 3);
    }
    // views
    @NonNull
    ...
    public FragmentDaywiseBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private FragmentDaywiseBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
