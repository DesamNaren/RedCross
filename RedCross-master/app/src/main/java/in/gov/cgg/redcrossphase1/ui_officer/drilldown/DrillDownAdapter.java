...
public class DrillDownAdapter extends RecyclerView.Adapter<DrillDownAdapter.DistrictViewHolder> {
    ...
    public DrillDownAdapter(FragmentActivity activity, List<String> headersList, List<StudentListBean> studentList) {
        this.mCtx = activity;
    ...
    public void onBindViewHolder(@NonNull final DistrictViewHolder holder, final int position) {
        ...
        holder.htv_mandal.setText(headStringList.get(1));
        holder.htv_village.setText(headStringList.get(2));
...
//
//        studentListBean.setDisrtict(studentList.get(position).get);
//        studentListBean.setMandal(studentList.get(position).get(1));
//        studentListBean.setVillage(studentList.get(position).get(2));
//        studentListBean.setName(studentList.get(position).get(4));
//        studentListBean.setGender(studentList.get(position).get(5));
//        studentListBean.setDob(studentList.get(position).get(5));
//        studentListBean.setPhone(studentList.get(position).get(7));
//        studentListBean.setBloodgp(studentList.get(position).get(8));
//        studentListBean.setEmail(studentList.get(position).get(9));
//        studentListBeanList.add(studentListBean);
//        this.data_dashbord.addAll(studentListBeanList);
...
//
    ...
    class DistrictViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView htv_name, htv_gender, htv_dob, htv_mobile, htv_bloodgroup, htv_email, htv_class, htv_instname, htv_insttpe,
                htv_district, htv_mandal, htv_village;
