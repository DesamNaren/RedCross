...
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.About_usFragment;
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.AbstractMembership;
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.BBInfoFragment;
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.BlooddonorRegistrationFragment;
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.CapacityBuildingsFragment;
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.CitiNewTCFragment;
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.CitiPrivacyPolicyFragment;
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.CitizendashboardFragment;
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.ContactusFragment;
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.DownloadCertificate;
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.HistoryFragment;
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.HomeNurseInfoFragment;
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.HomeNurseRequest;
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.HomeNursingRegistrationFragment;
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.HomenursingFragment;
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.LocateBloodbanksFragment;
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.MemberFragment;
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.MembershipFragment;
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.MembershipRegFormFragment;
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.MissionFragment;
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.ServicesFragment;
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.SevenFundamentalFragment;
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.Upcoming_fragment;
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.VisionFragment;
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Fragments.WhoWeAreFragment;
import in.gov.cgg.redcrossphase_offline.ui_officer.fragments.NewOfficerHomeFragment;
import in.gov.cgg.redcrossphase_offline.ui_officer.fragments.PrivacyPolicyFragment;
import libs.mjn.prettydialog.PrettyDialog;
import libs.mjn.prettydialog.PrettyDialogCallback;

public class CitiGuestMainActivity extends in.gov.cgg.redcrossphase_offline.ui_citiguest.LocBaseActivity {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                if (menuItem.getItemId() == R.id.nav_Dashboard) {
                    ...
                    GlobalDeclaration.FARG_TAG = HomeNursingRegistrationFragment.class.getSimpleName();
                    Intent i = new Intent(CitiGuestMainActivity.this, in.gov.cgg.redcrossphase_offline.ui_citiguest.LocateActivity.class);
                    startActivity(i);
                    ...
                    GlobalDeclaration.FARG_TAG = in.gov.cgg.redcrossphase_offline.ui_citiguest.InfoFragment.class.getSimpleName();
                    selectedFragment = new in.gov.cgg.redcrossphase_offline.ui_citiguest.InfoFragment();
                    callFragment(selectedFragment, GlobalDeclaration.FARG_TAG);
                    drawerLayout.closeDrawer(GravityCompat.START);
...
//                                startActivity(i);
                ...
                selectedFragment = new CitizendashboardFragment();
                callFragment(selectedFragment, GlobalDeclaration.FARG_TAG);
            } else if (GlobalDeclaration.FARG_TAG.equalsIgnoreCase(in.gov.cgg.redcrossphase_offline.ui_citiguest.InfoFragment.class.getSimpleName())) {
                GlobalDeclaration.FARG_TAG = CitizendashboardFragment.class.getSimpleName();
                selectedFragment = new CitizendashboardFragment();
                callFragment(selectedFragment, GlobalDeclaration.FARG_TAG);
