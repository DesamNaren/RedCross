...
public class MembershipDetailsSpinnerAdaptor extends ArrayAdapter<MembershipDetails_spinner_Bean> {

    LayoutInflater flater;

    public MembershipDetailsSpinnerAdaptor(Activity context, int resouceId, int textviewId, List<MembershipDetails_spinner_Bean> list) {
...
//        flater = context.getLayoutInflater();
    ...
    private View rowview(View convertView, int position) {
        ...
        MembershipDetails_spinner_Bean rowItem = getItem(position);
