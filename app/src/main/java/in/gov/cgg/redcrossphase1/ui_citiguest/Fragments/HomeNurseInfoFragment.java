...
public class HomeNurseInfoFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        Objects.requireNonNull(getActivity()).setTitle(getResources().getString(R.string.how_to_become_a_home_nurse));
        ...
        b.setText(getResources().getString(R.string.become_a_home_nurse));


//        String url = "http://uat2.cgg.gov.in:8081/redcross/getHowToPage?type=becomeDonor&reqFrom=Mobile";
        String url = BuildConfig.SERVER_URL + "getHowToPage?type=becomeHomeNurse&reqFrom=Mobile";
        ...
        pd.show();
        wb.setWebViewClient(new HomeNurseInfoFragment.MyWebViewHelpClient());
...
//                transaction.commitAllowingStateLoss();
                startActivity(new Intent(getActivity(), HomeNurseregNewActivity.class));
            }
        });
