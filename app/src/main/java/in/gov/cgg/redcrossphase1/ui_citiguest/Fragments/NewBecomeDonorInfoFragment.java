...
public class NewBecomeDonorInfoFragment extends Fragment {
    Button b;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        Objects.requireNonNull(getActivity()).setTitle("Basic Requirements");
...
//        String url = "http://uat2.cgg.gov.in:8081/redcross/getHowToPage?type=becomeDonor&reqFrom=Mobile";
        ...
        pd.show();
        wb.setWebViewClient(new NewBecomeDonorInfoFragment.MyWebViewHelpClient());
