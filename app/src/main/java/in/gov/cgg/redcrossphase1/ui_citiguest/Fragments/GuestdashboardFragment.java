...
public class GuestdashboardFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Objects.requireNonNull(getActivity()).setTitle(getResources().getString(R.string.dashboard));
        c = getActivity();
...
//        if (GlobalDeclaration.guest.equalsIgnoreCase("y")) {
        tv_username.setText(getResources().getString(R.string.hello) + getResources().getString(R.string.guest));
        ...
        switch (view.getId()) {
            case R.id.iv_whoweAre:
                ...
                getActivity().getSupportFragmentManager().beginTransaction()
                        .replace(R.id.fragment_citizendashboard, nextFrag, getResources().getString(R.string.findThisFragment))
                        .addToBackStack(null)
                        .commit();
                break;
            case R.id.iv_history:
                ...
                getActivity().getSupportFragmentManager().beginTransaction()
                        .replace(R.id.fragment_citizendashboard, nextFrag1, getResources().getString(R.string.findThisFragment))
                        .addToBackStack(null)
                        .commit();
                break;
            case R.id.iv_vission:
                ...
                getActivity().getSupportFragmentManager().beginTransaction()
                        .replace(R.id.fragment_citizendashboard, nextFrag2, getResources().getString(R.string.findThisFragment))
                        .addToBackStack(null)
                        .commit();
                break;
            case R.id.iv_mission:
                ...
                getActivity().getSupportFragmentManager().beginTransaction()
                        .replace(R.id.fragment_citizendashboard, nextFrag3, getResources().getString(R.string.findThisFragment))
                        .addToBackStack(null)
                        .commit();
                break;
...
//                        .addToBackStack(null)
//                        .commit();
                NewContactusFragment nextFrag4 = new NewContactusFragment();
                getActivity().getSupportFragmentManager().beginTransaction()
                        .replace(R.id.fragment_citizendashboard, nextFrag4, getResources().getString(R.string.findThisFragment))
                        .addToBackStack(null)
                        .commit();
                break;
            case R.id.iv_bloodbankDetails:
                ...
                getActivity().getSupportFragmentManager().beginTransaction()
                        .replace(R.id.fragment_citizendashboard, nextFrag5, getResources().getString(R.string.findThisFragment))
                        .addToBackStack(null)
                        .commit();
                break;
            default:
