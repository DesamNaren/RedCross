...
public class AllVillageFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        if (CheckInternet.isOnline(Objects.requireNonNull(getActivity()))) {
            allDistrictsViewModel =
                    ViewModelProviders.of(this, new CustomDistricClass(getActivity(), "d")).
            ...
            allDistrictsViewModel.getAllVillages("VillageWise", GlobalDeclaration.spn_year, value).
