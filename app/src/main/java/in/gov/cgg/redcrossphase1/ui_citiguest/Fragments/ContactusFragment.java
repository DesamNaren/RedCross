...
public class ContactusFragment extends Fragment implements SearchView.OnQueryTextListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        Objects.requireNonNull(getActivity()).setTitle(getResources().getString(R.string.contact_us));
...
//        }
        ...
        if (getArguments() != null) {
            fromType = getArguments().getString(getResources().getString(R.string.from_type));
            if (fromType != null && fromType.equalsIgnoreCase(getResources().getString(R.string.from_state))) {
                CallStateLogic();
            } else {
                CallDistLogic();
            }
    ...
    private void CallStateLogic() {
        GlobalDeclaration.cordinatorType = getResources().getString(R.string.s);
    ...
    private void prepareDistrictCordinatorsData() {
        ContactusDetails_Bean details = new ContactusDetails_Bean("Adilabad ",
                "Q.No: B5 & B6, White Quarters,\n" +
                        "Kailash Nagar, Adilabad\n" +
                        "ircsadilabad@gmail.com");
        ...
        ContactusDetails_Bean details2 = new ContactusDetails_Bean("Hyderabad", " H.No:10-5-1," +
                "Red Cross Vocational Training institute,  " +
                "Masab Tank, Hyderabad-28,\n" +
                "ircsbheemreddy@gmail.com");
