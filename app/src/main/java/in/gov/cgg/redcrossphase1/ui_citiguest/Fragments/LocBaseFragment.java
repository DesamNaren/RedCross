                ...
                .withListener(new MultiplePermissionsListener() {
                    ...
                    public void onPermissionsChecked(MultiplePermissionsReport report) {
                        if (report.areAllPermissionsGranted()) {
                            ...
                            flag = false;
                            showSettingsAlert(getString(R.string.grant_all_new));
...
//            dialog.show();
            ...
            builder1.setMessage(getString(R.string.grant_all));
...
//                    + "Lng:" + mCurrentLocation.getLongitude(), Toast.LENGTH_SHORT).show();
    ...
    private boolean checkPermissions() {
        ...
        int locationPermission2 = ContextCompat.checkSelfPermission(getActivity(),
                CAMERA);
        int locationPermission3 = ContextCompat.checkSelfPermission(getActivity(),
                WRITE_EXTERNAL_STORAGE);
        int locationPermission4 = ContextCompat.checkSelfPermission(getActivity(),
