...
public class DistrictContactFragment extends Fragment {
                    ...
                    observe(getActivity(), new Observer<ContactBean>() {
                        ...
                        public void onChanged(@Nullable ContactBean contactBean) {
                            if (contactBean != null) {
                                ...
                                binding.tvNodata.setText(getResources().getString(R.string.no_data_available));
                            }
                        }
                    });
        } else {
            Snackbar snackbar = Snackbar
                    .make(binding.rvContactUs, getResources().getString(R.string.no_internet), Snackbar.LENGTH_LONG);
            snackbar.show();
        }
