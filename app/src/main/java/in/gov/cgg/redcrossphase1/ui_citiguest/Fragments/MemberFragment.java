...
public class MemberFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        Objects.requireNonNull(getActivity()).setTitle("How to Become a Member");
        ...
        b.setText("Become a Member");


//        String url = "http://uat2.cgg.gov.in:8081/redcross/getHowToPage?type=becomeDonor&reqFrom=Mobile";
        String url = BuildConfig.SERVER_URL + "getHowToPage?type=becomeMember&reqFrom=Mobile";
        ...
        pd.show();
        wb.setWebViewClient(new MemberFragment.MyWebViewHelpClient());
