...
//        if (!GlobalDeclaration.role.contains("D")) {
        ...
        allDistrictsViewModel =
                ViewModelProviders.of(getActivity(), new CustomDistricClass(getActivity(),
                        "d")).get(AllDistrictsViewModel.class);
        if (CheckInternet.isOnline(getActivity())) {
            if (!GlobalDeclaration.role.contains("D")) {
                allDistrictsViewModel.getAllDistrcts("DistrictWise", GlobalDeclaration.spn_year).
                ...
                allDistrictsViewModel.getAllMandals("MandalWise", GlobalDeclaration.spn_year,
                        Integer.parseInt(GlobalDeclaration.districtId)).
