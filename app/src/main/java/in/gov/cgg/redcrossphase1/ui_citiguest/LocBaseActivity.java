...
//                            openSettings(LocBaseActivity.this);
                            showSettingsAlert(getResources().getString(R.string.grant_loc_permission));

                            Toast.makeText(LocBaseActivity.this, getResources().getString(R.string.loc), Toast.LENGTH_SHORT).show();
    ...
    private void showSettingsAlert(String string) {
        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(LocBaseActivity.this);
...
//
//            dialog.show();
            AlertDialog.Builder builder1 = new AlertDialog.Builder(LocBaseActivity.this);
        ...
        mFusedLocationClient.removeLocationUpdates(mLocationCallback)
                .addOnCompleteListener(this, new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(getApplicationContext(), getResources().getString(R.string.loc_stopped), Toast.LENGTH_SHORT).show();
                    }
                });
    }
