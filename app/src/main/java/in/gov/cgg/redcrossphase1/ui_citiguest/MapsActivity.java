...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switchView.setText(getResources().getString(R.string.show_bloodbank_list));

        requestPermissions();
        try {
            selectedThemeColor = MapsActivity.this.getSharedPreferences(getResources().getString(R.string.THEMECOLOR_PREF), MODE_PRIVATE).getInt(getResources().getString(R.string.theme_color), -1);
            setThemes();
                ...
                for (int i = 0; i < eRaktkoshResponseBeans.size(); i++) {
                    ...
                    if (otData.getLat() != null && otData.getLong() != null) {
                        ...
                        String finals = getResources().getString(R.string.name) + otData.getName() + "\n\n" +
                                getResources().getString(R.string.address) + otData.getAdd();
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        try {
                            ...
                            Toast.makeText(MapsActivity.this, getResources().getString(R.string.somethingwentwrong), Toast.LENGTH_SHORT).show();
                        }
                        break;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_LOCATION_TURN_ON) {
            if (resultCode == RESULT_OK) {
                ...
                new AlertDialog.Builder(MapsActivity.this).setCancelable(false).setTitle(getResources().getString(R.string.turn_on_loc)).setPositiveButton(getResources().getString(R.string.ok), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        turnOnLocation();
