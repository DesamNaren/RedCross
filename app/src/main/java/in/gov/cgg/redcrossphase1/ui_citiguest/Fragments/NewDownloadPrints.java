...
public class NewDownloadPrints extends LocBaseFragment {
    ...
    private void setupViewPager(ViewPager viewpager) {
        ...
        adapter.addFrag(new NewDownloadIDCardFragment(), "Download ID Card");
        adapter.addFrag(new NewDownloadCertificateFragment(), "Download Certificate");
