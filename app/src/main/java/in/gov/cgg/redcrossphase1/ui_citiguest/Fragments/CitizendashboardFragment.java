...
public class CitizendashboardFragment extends Fragment {
    ...
    private CircleImageView iv_main;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            if (GlobalDeclaration.guest != null) {
                if (GlobalDeclaration.guest.equalsIgnoreCase("y")) {
                    tv_username.setText(getResources().getString(R.string.welcome));

                } else if (GlobalDeclaration.loginresponse != null) {
                    tv_username.setText(getResources().getString(R.string.hello) + GlobalDeclaration.loginresponse.getName());
                } else if (GlobalDeclaration.unamefromReg != null) {
                    tv_username.setText(getResources().getString(R.string.welcome) + GlobalDeclaration.unamefromReg);
                } else {
                    tv_username.setText(getResources().getString(R.string.welcome_ircs));
                }
            } else if (GlobalDeclaration.loginresponse != null) {
                tv_username.setText(getResources().getString(R.string.hello) + GlobalDeclaration.loginresponse.getName());
            } else if (GlobalDeclaration.unamefromReg != null) {
        ...
        if (!GlobalDeclaration.profilePic.isEmpty()) {
            Glide.with(getActivity()).load(GlobalDeclaration.profilePic).into(iv_main);
        }
    ...
    private void findViews(View root) {
        iv_main = root.findViewById(R.id.img_main);
