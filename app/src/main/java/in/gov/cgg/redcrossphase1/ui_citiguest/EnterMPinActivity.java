...
//        tv_new.setText("Not you?");
        ...
        tv_forgot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder1.setMessage(getResources().getString(R.string.Proceed_to_submit_ticket));
...
//                        imm.toggleSoftInput(InputMethodManager.HIDE_IMPLICIT_ONLY, 0);
        ...
        tv_new.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putString(getResources().getString(R.string.mobile), "");
                editor.putString(getResources().getString(R.string.mpin), "");
                editor.apply();
...
//        });
    ...
    private boolean validateFields(View v) {
        if (pinView.getText().toString().trim().length() == 0 || pinView.getText().toString().trim().length() < 4) {
            Toast.makeText(EnterMPinActivity.this, getResources().getString(R.string.enter_validmpin), Toast.LENGTH_SHORT).show();
//
//            InputMethodManager imm = (InputMethodManager) getSystemService(Activity.INPUT_METHOD_SERVICE);
//            imm.toggleSoftInput(InputMethodManager.HIDE_IMPLICIT_ONLY, 0);
