...
import in.gov.cgg.redcrossphase_offline.ui_citiguest.Adaptors.MapAdaptor;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            eRaktkoshResponseBeans = bundle.getParcelableArrayList(AppConstants.E_RAKTAKOSH_DATA);
            fromClass = bundle.getString(AppConstants.FROM_CLASS);
//            progressBar.show();
